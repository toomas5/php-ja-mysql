...
<body>
    <div class="container mt-4" style="border: 1px solid black; padding: 1.5rem;">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $prevPageQuery = http_build_query(array_merge($_GET, ['lehekulg' => $eel_lk]));
                    $nextPageQuery = http_build_query(array_merge($_GET, ['lehekulg' => $jarg_lk]));
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/php/KT/admin/muuda_asutus.php?koht=<?php echo urlencode($id); ?>" class="btn btn-warning btn-sm">Muuda</a>
                                        <a href="/php/KT/admin/del_asutus.php?koht=<?php echo urlencode($id); ?>" class="btn btn-danger btn-sm">Kustuta</a>
                                    </td>
                                </tr>
                            <?php
                        }
                    } else {
                        echo "<tr><td colspan='5'>Pole andmeid</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
        ...
        <a href="uus_asutus.php" class="btn btn-success">Lisa Asutus</a>
